...
<div class="companies index large-12 medium-12 columns content">
        <div><h3><?= __('Companies') ?></h3></div><div class="pull-right"><?= $this->Html->link(__('Add New Company'), ['action' => 'add']) ?></div>
